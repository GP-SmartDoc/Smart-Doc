...
answer = generate_visualization(
    description= """
        "I need a visual breakdown of my current computing and development setup. Everything revolves around my main operating system, Arch Linux, which I customize using the Hyprland window manager. On the development side of things, my work is heavily focused on Machine Learning, Computer Vision, and Digital Signal Processing. I primarily write in Python and C++ for those ML and Vision projects, and I rely on CUDA programming when I need hardware acceleration. Outside of coding, the setup is also used for creative tasks and gaming. I use GIMP for image editing work like blending layers and adjusting ink colors, and I manage all my games through Lutris."
    """,
